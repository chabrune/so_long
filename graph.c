...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/20 15:08:00 by chabrune          #+#    #+#             */
/*   Updated: 2023/01/20 18:56:28 by chabrune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init(t_data *data, t_map map)
{
	...
	data->perso = \
	mlx_texture_to_image(data->mlx, mlx_load_png("PNG/perso.png"));
	data->wall = mlx_texture_to_image(data->mlx, mlx_load_png("PNG/wall.png"));
	data->col = \
	mlx_texture_to_image(data->mlx, mlx_load_png("PNG/collect.png"));
...
// 		}
// 		i++;
// 		if (data->perso->instances[0].y / 64 == data->exit->instances[0].y
// 			&& data->perso->instances[0].x / 64 == data->exit->instances[0].x
// 			&& data->check_C == 0)
...
int	open_window(t_data *data)
{
	...
	mlx_image_to_window(data->mlx, data->perso, \
		(64 * data->P_position.y), (64 * data->P_position.x));
